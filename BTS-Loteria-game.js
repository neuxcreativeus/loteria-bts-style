      ...
      const deck = [
        { title: "El Beso", img: "images/el-beso.webp", subtitle: "The Kiss 키스", accent: "#ff5fa2" },
        { title: "El Capitán", img: "images/el-capitan.webp", subtitle: "The Captain 선장", accent: "#7c4dff" },
        { title: "El Súper Atún", img: "images/el-super-atun.webp", subtitle: "The Super Tuna 슈퍼 참치", accent: "#ff7b2c" },
        { title: "El Conejo", img: "images/el-conejo.webp", subtitle: "The Bunny 토끼", accent: "#00c7ff" },
        { title: "El Corazón", img: "images/el-corazon.webp", subtitle: "The Heart 심장", accent: "#7a3cff" },
        { title: "El Elote", img: "images/el-elote.webp", subtitle: "The Corn 옥수수", accent: "#ff4d6d" },
        { title: "El Mesero", img: "images/el-mesero.webp", subtitle: "The Server 식당 종업원", accent: "#16a085" },
        { title: "La Luna", img: "images/la-luna.webp", subtitle: "The Moon 달", accent: "#f4b942" },
        { title: "El Pirata", img: "images/el-pirata.webp", subtitle: "The Pirate 해적", accent: "#ff8fab" },
        { title: "El Rey", img: "images/el-rey.webp", subtitle: "The King 왕", accent: "#4cc9f0" },
        { title: "El Sol", img: "images/el-sol.webp", subtitle: "The Sun 태양", accent: "#f06292" },
        { title: "El Soldado", img: "images/el-soldado.webp", subtitle: "The Soldier 군인", accent: "#8e24aa" },
        { title: "El Velero", img: "images/el-velero.webp", subtitle: "The Sail 돛", accent: "#ff6b6b" },
        { title: "El Violín", img: "images/el-violin.webp", subtitle: "The Violin 바이올린", accent: "#4caf50" },
        { title: "La Amistad", img: "images/la-amistad.webp", subtitle: "The Friendship 우정", accent: "#ff8f00" },
        { title: "La Bandera", img: "images/la-bandera.webp", subtitle: "The Flag 깃발", accent: "#ec4899" },
        { title: "La Corona", img: "images/la-corona.webp", subtitle: "The Corona 코러나 맥주", accent: "#3b82f6" },
        { title: "La Máscara", img: "images/la-mascara.webp", subtitle: "The Mask 가면", accent: "#14b8a6" },
        { title: "La Pirámide", img: "images/la-piramide.webp", subtitle: "The Pyramid 피라미드", accent: "#f472b6" },
        { title: "Los Churros", img: "images/los-churros.webp", subtitle: "The Churros 츄러스", accent: "#22c55e" },
        { title: "Los Jarritos", img: "images/los-jarritos.webp", subtitle: "The Jarritos 하리토스", accent: "#0f172a" },
        { title: "Los Marineros", img: "images/los-marineros.webp", subtitle: "The Sailors 선워들", accent: "#a855f7" },
        { title: "Los Tacos", img: "images/los-tacos.webp", subtitle: "The Tacos 타코들", accent: "#f59e0b" },
        { title: "Los Tambores", img: "images/los-tambores.webp", subtitle: "The Drums 용고 단청북", accent: "#38bdf8" }
      ];
